...
/// <summary>
/// Slack Integration Creation Dto
/// </summary>
[DataContract]
public class SlackIntegrationCreationDto : IntegrationCreationDto<SlackIntegration>
{
	/// <summary>
	/// Constructor
	/// </summary>
	public SlackIntegrationCreationDto() : base("slack")
	{
	}
